...
<div id="wrapper">
            ...
            <ul class="nav" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span><img alt="image" class="img-circle" src="${ctx}/resources/theme/images/profile_small.jpg" height="70" width="70"/></span>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab"  data-index="0" data-id="${ctx}/index">首页</a>
                </div>
            </nav>
            ...
            <a href="javascript:;" class="roll-nav roll-right J_tabExit" name="mainlogout" id="mainlogout" "><i
    ...
    <!-- 退出弹出层 -->
    <div id="logoutLayer" style="display:none" class="canteen-modal">
        <p class="deleteInfo modal-body">您确定要退出主界面吗？</p>
    </div>
